...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.image_upload_button = customtkinter.CTkButton(self.sidebar_frame, command=self.upload_image_event)
        self.image_upload_button.grid(row=2, column=0, padx=10, pady=10)
        self.image_upload_button.configure(text="upload image")
